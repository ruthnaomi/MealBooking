...
import ke.co.slab.mealbooking.ChefListActivity;
...
public class ChefAdapter extends RecyclerView.Adapter<ChefAdapter.ViewHolder> {
    ...
    public ChefAdapter(Context context, List<CartModel>cartModels) {
            ...
            if (isSuccess)
            {
                ...
                builder.setPositiveButton("Okay", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        context.startActivity(new Intent(context,ChefListActivity.class));
                    }
                });
            }else
            {
